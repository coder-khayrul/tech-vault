...
const UpdateProduct = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`https://app-orbit-server-zeta.vercel.app/products/${product._id}`, ProductData);
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-12"
                                        defaultValue={product.externalLinks.github}
                                    />
                                </div>
                            </div>
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-12"
                                        defaultValue={product.externalLinks.website}
                                    />
                                </div>
                            </div>
                        </div>
