            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        {!isLoggedIn ? (
                            <>
                                <ButtonTwo btnText={"Login"} onClickHandler={handleLogin}></ButtonTwo>
                                <ButtonTwo btnText={"Register"} onClickHandler={handleLogin}></ButtonTwo>
                                ...
                                <DropdownMenuContent className="w-60 bg-white border border-gray-200" align="end" forceMount>
                                    <DropdownMenuLabel className="font-normal">
                                        <div className="flex flex-col space-y-1">
                                            <p className="text-lg font-medium leading-none text-black">{user.name}</p>
                                    ...
                                    <DropdownMenuSeparator className="bg-gray-200" />
                                    <DropdownMenuItem onClick={handleLogout} className="text-red-600 hover:bg-gray-100">
                                    ...
                                    <div className="pt-4 border-t border-gray-200">
                                        {!isLoggedIn ? (
                                            <div className="space-y-2">
                                                ...
                                                <Button
                                                    className="w-full justify-start bg-indigo-500 text-white hover:bg-[#5a42d1]"
                                                    onClick={() => { handleLogin();}}
                                                >
                                                    Register
                                                </Button>
